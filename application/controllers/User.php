...
class User extends CI_Controller {
    ...
    public function add()
    {
		...
		if($dd->num_rows() > 0)
		{
			$this->session->set_userdata('pesan','<div id="notifikasi"><div class="alert alert-warning">
            ...
            $this->session->set_userdata('pesan','<div id="notifikasi"><div class="alert alert-success">
