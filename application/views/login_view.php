...
<div class="login-box">
  ...
  <div class="login-box-body" style="border:2px solid #226bbf;">
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <!-- alert err login -->
      <?php if($this->session->userdata('errUser')) : ?>
        <div class="alert alert-danger" role="alert">
          <?= $this->session->userdata("errUser"); ?>
          <?php $this->session->unset_userdata("errUser"); ?>
        </div>
      <?php elseif($this->session->userdata("errPass")) : ?>
        <div class="alert alert-danger" role="alert">
          <?= $this->session->userdata("errPass"); ?>
          <?php $this->session->unset_userdata("errPass"); ?>
        </div>
      <?php endif; ?>
      <!-- end -->
